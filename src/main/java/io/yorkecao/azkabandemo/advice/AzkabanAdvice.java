package io.yorkecao.azkabandemo.advice;

import io.yorkecao.azkabandemo.azkaban.AzkabanAdapter;
...
public class AzkabanAdvice {
    ...
    @Pointcut("execution(* io.yorkecao.azkabandemo.azkaban.AzkabanAdapter.*(..)))")
